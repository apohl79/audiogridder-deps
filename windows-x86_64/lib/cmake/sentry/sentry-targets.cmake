...
set_target_properties(sentry::sentry PROPERTIES
  ...
  INTERFACE_LINK_LIBRARIES "\$<\$<OR:\$<PLATFORM_ID:Linux>,\$<PLATFORM_ID:Android>>:-Wl,-E,--build-id=sha1>;\$<LINK_ONLY:dbghelp>;\$<LINK_ONLY:shlwapi>;\$<LINK_ONLY:version>;\$<LINK_ONLY:winhttp>;\$<LINK_ONLY:Threads::Threads>;\$<LINK_ONLY:>;\$<LINK_ONLY:sentry_crashpad::client>"
)
